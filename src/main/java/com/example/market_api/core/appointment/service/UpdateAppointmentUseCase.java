...
public class UpdateAppointmentUseCase {
    ...
    @Transactional
    public AppointmentResponseDto updateAppointment(UUID appointmentId, UpdateAppointmentForm form) {
        ...
        // Valida se o agendamento pode ser modificado
        appointmentService.validateCanBeModified(appointment);

        // Valida a nova data
        appointmentService.validateScheduledDateInFuture(form.getScheduledDate());

        appointment.reschedule(form.getScheduledDate(), form.getNotes());
