package com.example.solid_classes.core.product.model.mongo;
...
@SuperBuilder
@NoArgsConstructor
public class ProductDocument extends AuditableMongoEntity {
    ...
    /**
     * Classe interna para representar variações embutidas.
     * Não é uma entidade separada, faz parte do documento Product.
     */
    @Getter
    @Setter
    @NoArgsConstructor
